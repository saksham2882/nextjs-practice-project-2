            ...
            <div className="w-full max-w-md border-2 border-white rounded-2xl p-8 shadow-lg bg-gray-900">
                ...
                <form className="space-y-6" onSubmit={handleSignIn}>
                    ...
                    <p className="text-sm text-center mt-1">
                        ...
                        <span className="text-blue-400 hover:underline cursor-pointer" onClick={() => router.push("/register")}>
                            Register
                        </span>
                    </p>
                ...
                <button
                    className="w-full flex items-center justify-center gap-2 py-2 px-4 border border-gray-400 rounded-lg bg-white text-black hover:bg-yellow-100 transition-colors cursor-pointer"
                    onClick={async () => {
                        await signIn('google', {
                            callbackUrl: "/"
                        })
